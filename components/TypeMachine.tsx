...
const TypeMachine = (): JSX.Element => {
	const mappedType: Array<JSX.Element> = listTypes.map((item: ITypeMachineItem) => (
		<li className="item o-hidden tr-200 border f-row-center-start" key={ uuidv4() }>
